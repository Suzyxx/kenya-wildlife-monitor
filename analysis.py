...
<p>Mpala Research Centre, Laikipia County — Report generated {datetime.utcnow().strftime('%Y-%m-%d %H:%M')} UTC</p>
...
<tr><td>Conservationists</td><td>Shannon H' = {kpis['mean_shannon_index']}</td><td>Biodiversity health score for this site</td></tr>
<tr><td>Safari Operators</td><td>Peak hour activity</td><td>Schedule game drives at highest-activity hours</td></tr>
<tr><td>Researchers</td><td>{kpis['endangered_sightings']} endangered sightings</td><td>Population presence confirmed</td></tr>
<tr><td>Kenya Wildlife Service</td><td>Night activity {kpis['pct_night_activity']}%</td><td>Unusual night patterns may indicate disturbance</td></tr>
</table>

<footer>Generated by Kenya Wildlife Biodiversity Monitor · IoT & Big Data · {datetime.utcnow().year}</footer>
