...
<p>Bushtops, Maasai Mara — Report generated {datetime.now(ZoneInfo('Europe/Brussels')).strftime('%Y-%m-%d %H:%M')} CEST</p>
...
<table>
<tr><th>Stakeholder</th><th>Key Metric</th><th>Economic Insight</th></tr>
<tr><td>Camp Management</td><td>{kpis['pct_frames_with_animal']}% frames with animals</td><td>Consistent wildlife presence reduces guest disappointment risk and supports repeat bookings</td></tr>
<tr><td>Safari Guides</td><td>Peak activity hours</td><td>Schedule drives at optimal windows; species distribution sets realistic guest expectations in pre-drive briefings</td></tr>
<tr><td>Marketing &amp; Sales</td><td>Peak {kpis['peak_animals_in_frame']} animals in frame</td><td>Quantifiable herd density and species variety justify premium nightly rates in marketing materials</td></tr>
<tr><td>Revenue Manager</td><td>Hourly activity patterns</td><td>Identify high-value time slots to support dynamic pricing for morning vs. afternoon game drive packages</td></tr>
<tr><td>Conservation Partners</td><td>Shannon H' = {kpis['mean_shannon_index']}, {kpis['endangered_sightings']} endangered sightings</td><td>High Shannon H' score and rare species sightings provide scientific evidence of a healthy ecosystem, useful for conservation funding and reporting</td></tr>
</table>

<footer>Generated by Kenya Wildlife Biodiversity Monitor · IoT & Big Data · {datetime.now(ZoneInfo('Europe/Brussels')).year}</footer>
